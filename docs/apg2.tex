...
\title{The draft genomes of *Aphaenogaster* species from across a
  biogeographic gradient}

% Use letters for affiliations, numbers to show equal authorship (if applicable) and to indicate the corresponding author
\author[a,1]{Matthew K. Lau}
\author[a]{Aaron M. Ellison} 
\author[b]{A. Nguyen} 
\author[b]{S.H. Cahan}
\author[c]{B. DeMarco} 
\author[d]{C. Penick} 
\author[b]{N.J. Sanders} 
\author[d]{R. Dunn} 
\author[b]{N.J. Gotelli}

\affil[a]{Harvard Forest, Harvard University, Petersham, MA 01366}
\affil[b]{Department of Biology, University of Vermont, Burlington, VT 05405}
\affil[c]{Michigan}
\affil[d]{North Carolina}
...
gaps. The genomes of all six species were successfully sequenced; and
both raw sequences and the assembled genomes are currently stored at
...
\begin{enumerate}
\item Figure 1: Ant photos and outgroup
\item Table 1: Quality/composition among ants and outgroup 
\item Figure 2: Climate-gradient map with ant overlays
\item Figure 3: RAxML protein phylogeny
\item Figure 4: Transcriptome Target Gene Maps
\item Figure 5: Transcriptome Target Gene similarities
\item Table 2: Mantel table for target gene similarity and geography
\end{enumerate}
